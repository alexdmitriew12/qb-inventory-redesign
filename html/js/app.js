    ...
    $.post(
        ...
        function(data) {
            ...
            $(".weapon-attachments-container-details").html(
                '<span style="font-weight: bold; letter-spacing: .1vh;">Numer seryjny</span><br> ' +
                ClickedItemData.info.serie +
                '<br><br><span style="font-weight: bold; letter-spacing: .1vh;">Wytrzymałość - ' +
                Durability.toFixed() +
    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>Imię: </strong><span>" +
                itemData.info.firstname +
                "</span></p><p><strong>Nazwisko: </strong><span>" +
                itemData.info.lastname +
                "</span></p><p><strong>Data urodzenia: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>Płeć: </strong><span>" +
                gender +
                "</span></p><p><strong>Pochodzenie: </strong><span>" +
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>Data urodzenia: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>Licencje: </strong><span>" +
                itemData.info.type +
                "</span></p>"
            );
            ...
            if (itemData.info.attachments != null) {
                ...
                $(".item-info-description").html(
                    "<p><strong>Numer seryjny: </strong><span>" +
                    itemData.info.serie +
                    "</span></p><p><strong>Amunicja: </strong><span>" +
                    itemData.info.ammo +
                    "</span></p><p><strong>Dodatki: </strong><span>" +
                    attachmentString +
                    "</span></p>"
                );
            } else {
            ...
            if (itemData.info.type == "casing") {
                $(".item-info-description").html(
                    "<p><strong>Dowód: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Rodzaj: </strong><span>" +
                    itemData.info.ammotype +
                    "</span></p><p><strong>Kaliber: </strong><span>" +
                    itemData.info.ammolabel +
                    "</span></p><p><strong>Numer seryjny: </strong><span>" +
                    itemData.info.serie +
                    "</span></p><p><strong>Miejsce zdarzenia: </strong><span>" +
                ...
                $(".item-info-description").html(
                    "<p><strong>Dowód: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Krew: </strong><span>" +
...
(() => {
    ...
    Inventory.UseItem = function(data) {
        ...
        $("#itembox-action").html("<p>Użyto 1x</p>");
    ...
    Inventory.itemBox = function(data) {
        ...
        var type = "Użyto " + data.itemAmount + "x";
        if (data.type == "add") {
          type = "Otrzymano " + data.itemAmount + "x";
        } else if (data.type == "remove") {
          type = "Usunięto " + data.itemAmount + "x";
        }
